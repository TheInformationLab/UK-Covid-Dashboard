...
class TableauEmbed extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    console.log('[TableauEmbed.jsx] componentWillReceiveProps', nextProps);
    ...
    const isOptionsChanged = !shallowequal(this.props.options, nextProps.options);
    const isLoading = this.state.loading;

    // Only report is changed - re-initialize
    if (isReportChanged) {
      console.log('[TableauEmbed.jsx] Report Changed');
      this.initTableau(nextProps.options);
    }

    // Only report is changed - re-initialize
    if (isOptionsChanged) {
      console.log('[TableauEmbed.jsx] Options Changed');
      this.initTableau(nextProps.options);
    }
...
TableauEmbed.propTypes = propTypes;
TableauEmbed.defaultProps = defaultProps;
